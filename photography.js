...
(function () {
            ...
            '<div class="lightbox" id="kt-lightbox" role="dialog" aria-modal="true" aria-label="Photo viewer">',
              ...
              '<div class="lightbox-panel">',
                ...
                '<div class="lightbox-info" id="lb-info">',
                  /* content injected by populateLightbox() */
                '</div>',
    ...
    /* Get the flat list index of the first photo in a given album */
